...
def register(subparsers):
    parser = subparsers.add_parser("graph", help="Build connection graph")
    parser.add_argument("query", help="Email or username for graph")
...
def run(args):
    try:
        # Визначаємо тип: email чи username
        try:
